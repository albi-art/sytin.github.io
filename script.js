var questions = {
    1: {
      text: "Полиция арестовала предполагаемых смутьянов: всего за два дня было задержано 197 человек, их них три четверти, то есть 144 человека, в возрасте до 17 лет. О каком времени идет речь?",
      alternates:{
        1: {
