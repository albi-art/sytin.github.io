var questions = {
  ...
  3: {
    ...
    alternates:{
      ...
      2: {
        value: "В 1906 году с такой инициативой выступил Николай II, когда Столыпин взял руководство над почтой и телеграфами",
        comment: "Нет, он не предлагал ничего подобного"
      },
      3: {
  ...
  5: {
    ...
    alternates:{
      ...
      3: {
        value: "Так Михаил Лесин купил долю в «Независимой газете» Березовского",
  ...
  6: {
    ...
    alternates:{
      1: {
        value: "Борис Березовский написал эту статью в 1999 году",
...
var showBiographyBlock = function(){
  showContent('biography-block');
}

var showTestBlock = function(){
  showContent('test-block');
}

var manElem = document.getElementById('man-circle');
var scoresElem = document.getElementById('scores-circle');

manElem.onclick = function(){setTimeout(showBiographyBlock, 100)};
scoresElem.onclick = function(){setTimeout(showTestBlock, 100)};
